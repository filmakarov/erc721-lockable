...
import "./ERC721OZLockable.sol";

/// @title Extension with EIP2612-like permits for ERC721 by Open Zeppelin
/// @dev   Implements EIP4494 and additionally permitAll

abstract contract ERC721OZLockablePermittable is ERC721OZLockable {  
